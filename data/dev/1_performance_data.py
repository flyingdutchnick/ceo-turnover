...
stock_data_head_df = pd.read_csv(stock_data_no_returns_path).head(n=1000)

stock_data_head_path = "csv_files/na-monthly-share-price-head.csv"

stock_data_head_df.to_csv(stock_data_head_path)

# eventual location of share price dataset with returns added
stock_data_with_returns_path = "csv_files/stock-data-with-returns.csv"

# initialize IntegrateStockData instance to calculate share price returns and add them to the dataset
stock_data_add_returns = IntegrateStockData(stock_data_head_path, stock_data_with_returns_path)
...
stock_data_returns_volatility_path = "csv_files/stock-data-returns-volatility.csv"
